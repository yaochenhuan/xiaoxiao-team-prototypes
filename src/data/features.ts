          ...
          blocks: [
            ...
            tbl(
              ...
              [
                ...
                ['批量操作栏', '底部固定', '已选 N 项 + "开始练习" + "查看/订正" + "移除错题"，选中 ≥ 1 时按钮可用，否则置灰', 'M004'],
              ],
            ),
            h3('交互逻辑'),
            ol([
              ...
              '用户勾选错题行 → 底部批量栏显示已选数量；"开始练习""查看/订正""移除错题"在选中 ≥ 1 时可用，否则置灰（置灰态 #CBD0D6）。',
              '用户点击"开始练习" → 跳转答题页面，携带已选错题 ID。',
              '用户点击"查看/订正" → 跳转结果页，展示已选错题的答题结果与订正信息。',
              '用户点击"移除错题" → 弹出确认弹窗，确认后删除已选错题，toast 反馈。',
        ...
        // ========== P002 基础训练 ==========
        {
          ...
          blocks: [
            ...
            ol([
              ...
              '用户勾选训练题行 → 底部批量栏显示已选数量；"开始练习""查看/订正""移除错题"在选中 ≥ 1 时可用，否则置灰。',
              '用户点击"开始练习" → 跳转答题页面，携带已选训练题 ID。',
              '用户点击"查看/订正" → 跳转结果页，展示已选训练题的答题结果与订正信息。',
              '用户点击"移除错题" → 弹出确认弹窗，确认后删除已选训练题，toast 反馈。',
              '点击"标记掌握" → 立即乐观更新状态。',
            ]),
          ],
        },
...
└──────────────────────────────────────────┘`,
            ...
            ol([
              ...
              '用户勾选错词卡片 → 底部批量栏显示已选数量；"移除错词"在选中 ≥ 1 时可用，否则置灰。',
              '用户点击"移除错词" → 弹出确认弹窗，确认后删除已选错词，toast 反馈。',
            ]),
          ],
        },
        ...
        // ========== 模块设计说明 ==========
        {
          ...
          blocks: [
            ...
            h3('M004 — 错题列表 + 筛选'),
            p('原型绑定：P001 / P002 右侧主体表格。5 个筛选 + 1 个开关 + 排序，支持单选/全选，行 hover 浅灰底，状态徽标带颜色。底部批量操作栏含"开始练习""查看/订正""移除错题"。'),
            h3('M005 — 错词本 + 生词本'),
            ...
            h3('M007 — 错词卡片网格'),
            p('原型绑定：P003 右侧 2 列网格。每张卡片含单词、双音标、发音按钮、释义、英文例句、中文翻译、错误数、星标。支持勾选，底部批量栏含"移除错词"。支持 hover 阴影效果。'),
          ],
        },
        ...
        // ========== 验收标准 ==========
        {
          ...
          blocks: [
            ...
            ul([
              ...
              '批量勾选 ≥ 1 项时"开始练习""查看/订正""移除错题"可用，否则置灰。',
            ]),
            h4('P002 基础训练页'),
            ul([
            ...
            ul([
              ...
              '支持勾选错词卡片，底部"移除错词"在选中 ≥ 1 时可用，点击后弹出确认弹窗。',
            ]),
            h3('5.2 UI 状态验收'),
            tbl(
              ['状态', 'P001 / P002', 'P003'],
